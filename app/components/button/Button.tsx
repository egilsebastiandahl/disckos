...
export default function Button({ children, onClick, className, disabled, variant = "default" }: ButtonProps) {
  ...
  const baseClasses = "px-4 py-2 rounded-xl hover:cursor-pointer border border-transparent transition shadow-sm disabled:opacity-50 disabled:cursor-not-allowed";
