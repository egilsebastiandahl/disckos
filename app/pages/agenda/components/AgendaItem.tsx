...
export default function AgendaItem({ event, isNextEvent }: AgendaItemProps) {
  ...
  return (
    <div
      className={`border border-foreground shadow p-4 mb-4 rounded-lg w-full min-w-sm md:max-w-xl ${isPastEvent ? "opacity-50" : ""} ${isNextEvent ? "bg-foreground text-background" : ""}`}
