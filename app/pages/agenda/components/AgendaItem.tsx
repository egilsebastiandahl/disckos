...
export default function AgendaItem({
  ...
  return (
    <div
      className={`border border-foreground p-4 mb-4 rounded-lg w-full md:min-w-sm md:max-w-xl ${orientation === "left" ? "" : ""} ${isPastEvent ? "opacity-50" : ""} ${isNextEvent ? "bg-foreground text-background" : ""}`}
