...
export default function AgendaItem({
  ...
  return (
    <div
      className={`border border-foreground p-4 mb-4 rounded-lg max-w-2xs md:max-w-sm ${orientation === "left" ? "" : ""} ${isPastEvent ? "opacity-50" : ""} ${isNextEvent ? "bg-foreground text-background" : ""}`}
