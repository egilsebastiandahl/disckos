...
export default function PlayerScorePerHole({ holeNumber, playerName, playerScore, setPlayerScoreForHole }: PlayerScorePerHoleProps) {

    return (
        <div className="flex gap-2 items-center">
            <span>{playerName}: </span>
            <Button onClick={() => setPlayerScoreForHole(holeNumber, playerScore.playerId, playerScore.throws - 1)} disabled={playerScore.throws <= 0}>-</Button>
